...
export class UploadResolver {
  ...
  async presignedUrlS3(
    ...
    return await this.uploadService.presignedUrlS3(currentUser.id, presignedUrlDto);
  }

  @Mutation(() => String)
  async deleteFileS3(@Args('deleteFileDto') deleteFileDto: DeleteFileDto): Promise<string> {
  ...
  @Mutation(() => IPreSignUrl)
  async presignedUrlS3Public(@Args('presignedUrlDto') presignedUrlDto: PresignedUrlDto): Promise<IPreSignUrl> {
